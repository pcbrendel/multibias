...
#'  where S represents binary selection, X* is the binary misclassified exposure,
#'  Y is the binary outcome, C represents the vector of binary measured confounders
