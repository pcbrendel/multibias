...
#'  with probability = S from df_uc_emc_source then removing the columns X, U,
#'  and S. The resulting data corresponds to what a researcher would see in the
#'  real-world: a misclassified exposure, Xstar; missing data on a confounder U;
#'  and missing data for those not selected into the study (S=0). As seen
#'  in df_uc_emc_source, the true, unbiased exposure-outcome odds ratio = 2.
#'
