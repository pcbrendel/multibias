...
#' 100,000 observations. This data is obtained from \code{df_uc_em_source}
...
#' \emph{U}. As seen in \code{df_uc_em_source}, the true, unbiased
...
#' \code{df_uc_em} and can be used to obtain bias parameters for purposes
#' of validating the simultaneous multi-bias adjustment method with
#' \code{df_uc_em}. With this source data, the fitted regression
