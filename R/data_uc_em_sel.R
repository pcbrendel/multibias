...
#' with probability = \emph{S} from \code{df_uc_em_sel_source} then removing
...
#' \code{df_uc_em_sel_source}, the true, unbiased exposure-outcome
#' odds ratio = 2.
#'
...
#' Data source for \code{df_uc_em_sel}
#'
...
#' \code{df_uc_em_sel} and can be used to obtain bias parameters for purposes
#' of validating the simultaneous multi-bias adjustment method with
#' \code{df_uc_em_sel}. With this source data, the fitted regression
