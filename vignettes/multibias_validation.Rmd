...
The `data_observed` and `bias_params` objects are specified as inputs of `multibias`. In addition, we will indicate that we want results ran over 1,000 bootstrap samples.
